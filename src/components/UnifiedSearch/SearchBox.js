  ...
  return (
    <StyledSeachBoxWrapper>
      <div className="searchInputWrapper">
        ...
        <form className={className} onSubmit={(e) => e.preventDefault()}>
          <input
            ...
            type="text"
            placeholder="検索したいキーワードを入れてください。"
            aria-label="Search"
      ...
      <div className="searchSuggestionsWrapper">
        <span className="suggestions-label">人気記事：</span>
        {searchSuggestions.map((suggestion) => (
          <button
            key={suggestion}
            className={`technicalsite-suggestion-btn cursorPointer ${
