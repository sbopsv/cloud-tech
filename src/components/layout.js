...
const MenuNavToggle = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path fillRule="evenodd" clipRule="evenodd" d="M3 2.25C2.58579 2.25 2.25 2.58579 2.25 3V21C2.25 21.4142 2.58579 21.75 3 21.75H9H21C21.4142 21.75 21.75 21.4142 21.75 21V3C21.75 2.58579 21.4142 2.25 21 2.25H9H3ZM9.75 3.75V20.25H20.25V3.75H9.75ZM8.25 3.75H3.75V20.25H8.25V3.75Z" fill="#ff6a00"/>
  </svg>
...
const Layout = ({ children, location }) => {
  ...
  const [isShowSubscribe] = useState(true);
        ...
        <Wrapper className={((toggleSideBar) ? " mainWrapperCollapse" : "")}>
          ...
          <LeftSideBarWidth className={((toggleSideBar) ? " sidebarWrapperCollapse" : "") + ((isSubNavShow) ? " translateXZero" : "")}>
            ...
            </div>
            {
              !toggleSideBar ? (
                <div className="p16">
                  <Sidebar location={location} sideBarULdecreaseHt = { isShowSubscribe  }/>
                </div>
              ) : null
            }
          </LeftSideBarWidth>
                  ...
                  <LanguageWrapper ref={wrapperRef}>
                    <div className="languageWrapper">
                      <div className="githubStars">
                        <GitHubButton
                          href="https://github.com/sbopsv/cloud-tech"
                          data-size="large"
                          data-show-count="true"
                          aria-label="Star @SoftBank on GitHub"
                        >
                          Star
                        </GitHubButton>
                      </div>
